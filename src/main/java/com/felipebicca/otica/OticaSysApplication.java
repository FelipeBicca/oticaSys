...
public class OticaSysApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Pessoa p1 = new Pessoa(null, "Felipe Damasceno Bicca", "01724658000", "4096661881", "Masculino", "Casado",
				sdf.parse("30/09/1988"));
		Pessoa p2 = new Pessoa(null, "Raline Simões Saraiva", "05259773098", "1127632006", "Feminino", "Solteira",
				sdf.parse("03/04/2002"));
